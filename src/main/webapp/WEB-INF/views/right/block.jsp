							...
							<div class="card">
								<div class="card-body">
									<div class="form-center">
										<img src="<%=context %>/profile_image/${b.uimage}"
											class="rounded-circle" width="20" width="20"> <a
											class="card-title text-dark" style="font-size: 0.8em">${b.unickname }</a><br>
										<a class="card-subtitle mb-2 text-muted"
											style="font-size: 0.8em">@${b.uatid }</a> <input
											id="${b.blcode}" type="button"
											class="btn btn-outline-danger btn-sm float-right"
											value="차단 취소" style="font-size: 0.7rem"
											onclick="location.href='blockdelete?blcode=${b.blcode}'">
									</div>
								</div>
							</div>
						</c:forEach>
